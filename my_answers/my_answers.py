...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        print("*", hidden_outputs * output_error_term)
        #test = hidden_outputs * output_error_term
        #print(test.shape)
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        self.weights_hidden_to_output = self.weights_hidden_to_output + ((delta_weights_h_o * self.lr) / n_records) # update hidden-to-output weights with gradient descent step
